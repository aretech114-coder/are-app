import {
  Mail, Bot, Plane, CalendarDays, Users, Briefcase, Receipt, Archive, Webhook, Building2, Lock, CheckCircle2,
} from "lucide-react";
...
const modules: ModuleCard[] = [
  ...
  { name: "API REST Publique", description: "Endpoints sécurisés par clé API pour les intégrations tierces", icon: Webhook, status: "active" },
  { name: "Multi-tenant", description: "Partitionnement des données par organisation", icon: Building2, status: "preparing" },
